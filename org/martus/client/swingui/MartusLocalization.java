...
public class MartusLocalization
{
	...
	public void loadEnglishTranslations()
	{
		...
		addEnglishTranslation("field:aboutDlgVersionInfo=Martus(TM) software version");
		addEnglishTranslation("field:aboutDlgBuildDate=Built on");
		addEnglishTranslation("field:aboutDlgCopyright=Copyright 2002 Beneficent Technology, Inc. (Benetech, at www.benetech.org).");
		addEnglishTranslation("field:aboutDlgDisclaimer=Martus comes with ABSOLUTELY NO WARRANTY, and is made available under license terms in the file named license.txt in the Martus directory. This is free software, and you are welcome to redistribute it under certain conditions discussed in license.txt. ");
