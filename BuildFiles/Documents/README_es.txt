Martus(tm) Software Versión 3.3 README_es.txt
---------------------------------------------

Contenido:
A. Cambios de la versión 3.2 a la versión 3.3     (08-2008)
B. Cambios de la versión 3.1 a la versión 3.2     (09-2007)
C. Cambios de la versión 3.0 a la versión 3.1     (04-2007)
D. Cambios de la versión 2.9 a la versión 3.0     (09-2006)
E. Cambios de la versión 2.8.1 a la versión 2.9   (03-2006)
F. Cambios de la versión 2.8 a la versión 2.8.1   (11-2005)
G. Cambios de la versión 2.7.2 a la versión 2.8   (09-2005)
H. Cambios de la versión 2.7 a la versión 2.7.2   (08-2005)
I. Cambios de la versión 2.6 a la versión 2.7     (04-2005)
J. Cambios de la versión 2.5 a la versión 2.6     (02-2005)
K. Cambios de la versión 2.0.1 a la versión 2.5   (11-2004)
L. Cambios de la versión 2.0 a la versión 2.0.1   (08-2004)
M. Cambios de la versión 1.5 a la versión 2.0     (07-2004)
N. Cambios de la versión 1.2.1 a la versión 1.5   (02-2004)
O. Cambios de la versión 1.2 a la versión 1.2.1   (12-2003)
P. Cambios de la versión 1.0.3 a la versión 1.2   (09-2003)
Q. Cambios de la versión 1.0.2 a la versión 1.0.3 (05-2003)
R. Cambios de la versión 1.0.1 a la versión 1.0.2 (02-2003)
S. Cambios de la versión 1.0 a la versión 1.0.1   (01-2003)
T. Instrucciones especiales para actualizar Winsock, si
...
A. Cambios de la versión 3.2 a la versión 3.3

Esta versión está disponible en inglés, español y en otros
...
NOTA (comienzo disponible en Martus 3.1, pero todavía no 
incluido en la Guía de Usuario): Hay un mecanismo adicional para 
acelerar la carga de Martus y la navegación cuando una cuenta 
tiene un número grande de boletines. Puede agregar 
“ –-folders-unsorted” al final de la orden en su atajo de 
Martus en su Desktop. Este hará que carpetas en Martus sean no 
clasificadas ("sorted") cuando al principio los carga (porque 
la clasificación puede llevar tiempo cuando tiene muchos 
boletines.) Siempre puede hacer clic en un encabezado de columna 
en la lista de vista anticipada de boletines para clasificar la 
carpeta si desea, pero incluyendo esta opción ahorrará el tiempo 
en el arranque y en la entrada en nuevas carpetas en Martus.


B.  Cambios de la versión 3.1 a la versión 3.2
...
C. Cambios de la versión 3.0 a la versión 3.1    
...
D. Cambios de la versión 2.9 a la versión 3.0
...
E. Cambios de la versión 2.8.1 a la versión 2.9
...
F. Cambios de la versión 2.8 a la versión 2.8.1
...
G. Cambios de la versión 2.7.2 a la versión 2.8
...
H. Cambios de la versión 2.7 a la versión 2.7.2
...
I. Cambios de la versión 2.6 a la versión 2.7
...
J. Cambios de la versión 2.5 a la versión 2.6
...
K. Cambios de la versión 2.0.1 a la versión 2.5
...
L. Cambios de la versión 2.0 a la versión 2.0.1
...
M. Cambios de la versión 1.5 a la versión 2.0
...
N. Cambios de la versión 1.2.1 a la versión 1.5
...
O. Cambios de la versión 1.2 a la versión 1.2.1
...
P. Cambios de la versión 1.0.3 a la versión 1.2
...
Q. Cambios de la versión 1.0.2 a la versión 1.0.3
...
R. Cambios de la versión 1.0.1 a la versión 1.0.2
...
S. Cambios de la versión 1.0 a la versión 1.0.1
...
T. Instrucciones especiales si necesita actualizar Winsock al
