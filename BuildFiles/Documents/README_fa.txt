...
-	ساحات پائین شونده ناشی از اطلاعات (لِست های پائین شونده بوسیله اطلاعات 
  وارد شده در یک مشبک رویداد خبری ایجاد گردید) به لِست ساحات موجود جهت 
  جستجو در صفحه نمایش جستجو اضافه گردید.
-	پویش و بارگذاری قیمت های وارد شده در ساحات رویداد خبری در خانه خالی 
  "جستجو برای..." برای متن و انواعِ ساحه پائین شونده ناشی از اطلاعات در 
  صفحه نمایش جستجو اضافه گردید. هنگام چیدن ساحات متن جهت جستجو در صفحه 
  نمایش انتخاب ساحه، کاربران در صورت میل می توانند قوطی مارک دار 
  "بارگذاری همه قیمت های محتمل برای ساحه انتخاب شده" را انتخاب نمایند تا 
  قوطی "جستجو برای..." با قیمت هایی که در همه رویدادهای خبری در کمپیوتر 
  محلی وارد گردیده اند، خانه پُری شود. برای پائین شونده های-ناشی از 
  اطلاعات، قیمت ها هنگام انتخاب ساحه در صفحه نمایش، بطور اتومات در 
  رویدادهای خبری بارگذاری می گردند. اگر کاربران خواسته باشند، بدون رفتن 
  به صفحه نمایش انتخاب ساحه، جهت بارگذاری قیمت های ساحه یک دکمه 
  "بارگذاری همه قیمت های محتمل برای ساحه انتخاب شده" در جستجوی اصلی صفحه 
  نمایش نیز موجود می باشد (بطور مثال، پس از بارگذاری جستجوی ثبت شده 
  قبلی، و یا در صورتیکه آنها قوطی مارک دار را در ساحه انتخاب صفحه نمایش 
  انتخاب نکرده باشند). قیمت های بارگذاری شده به ترتیب الفبا، نه به 
  ترتیبی که در مشبک منبع اطلاعات وارد گردیده بودند، تنظیم می شوند. 
-	قیمت های پائین شونده های ناشی از اطلاعات، هنگام تصحیح رویدادهای خبری 
  با هدف ورود اطلاعات به آسانی، که بعوض تنظیم به ترتیب ورودشان در مشبک 
  منبع اطلاعات به ترتیب الفبا تنظیم تنظیم می شوند، تغیر یافته است.
-	حساب های مقرهای فرماندهی می توانند بدون محو نسخه های قبلی، ساحه تازه 
  کاری شده رویدادهای خبری مسوده را حصول مجدد نمایند.
-	جایی که Martus شرایط جستجوی قبلی تان را که حاوی ساحه "آخرین تاریخ 
  ثبت شده" است به یاد نداشته باشد، خطای آن درست شده است
-	خطای توضیح شده به کاربر در صورتیکه مقرهای فرماندهی سعی نماید تا 
  رویدادهای خبری ایجاد شده بوسیله یک حساب میزی را قفل نماید. یک حساب 
  مقرهای فرماندهی بخودی خود نمی تواند مستقیماً ساحه مسوده رویدادهای خبری 
  حاصل شده (انفرادی یا مجموعی) را قفل کند، اما می تواند ساحه مسوده 
  رویدادهای خبری حاصل شده را تغیر داده، مالک آن مسوده ها شده و سپس آنها 
  را قفل کند.
-	خطایی که هنگام چاپ و فرستادن هر کدام از قطعات عامه رویدادهای خبری به 
  ماشین جستجوی Martus، اطلاعات را از ستون های پائین شونده قابل استفاده 
  مکرر در داخل یک مشبک حذف می کرد، برداشته شده است.
-	ترجمه دری برای نمای کاربر  تازه کاری شده و گزینه های ترجیحی تقویم شمسی 
  افغانی اضافه گردیده است.
-	نمایش ترمیم شده ساحات پائین شونده قابل استفاده مکرر برای لسان های 
  راست به چپ، از طرف راست
-	ترمیم چندین خطاهای کوچک، توضیحات، و پاک کاری صفحات نمایش کاربر.
