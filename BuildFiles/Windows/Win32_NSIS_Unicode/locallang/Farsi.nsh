...
; shortcuts
!insertmacro LANG_STRING StartMenuShortcutQuestion_Text "آيا دل تان مي خواهد علامتِ Martus براي کليک کردن در فهرست شروع(Start) نصب گردد؟"
!insertmacro LANG_STRING DesktopShortcutQuestion_Text "آيا دل تان مي خواهد علامتMartus روي صفحهء كامپيوترتان نصب گردد؟"
...
!insertmacro LANG_STRING NewerVersionInstalled_Text "نسخهء تازه تري ($EXISTING_MARTUS_VERSION) از برنامهء ${PRODUCT_NAME} از قبل نصب شده است. شما بايد اول نسخهء موجود را پاک کنيد تا بتوانيد اين نسخهء قديمي تر را نصب کنيد. توجه کنيد اگر به نسخهء کهنه تر برمي گرديد بعضي از کارکردها را از دست خواهيد داد، و ممکن است نتوانيد بولتن هايي که با نسخهء تازه تر تهيه شده اند را ببينيد. براي حفظ نسخهء جديد تر دکمهء 'تأييد' را کليک کنيد که از برنامه خارج تان مي کندو اما اگر کماکان نسخهء قديمي تر را مي خواهيد، علارغم از دست دادن کارکردهاي تازه، اول از برنامه خارج شويد، بعد برنامه را حذف کنيد، سپس نسخهء قديمي تر را نصب کنيد."
...
!insertmacro LANG_STRING RemoveInstallShieldVersion_Text "يک نسخهء قديمي تر از${PRODUCT_NAME} روي كامپيوتر شما موجود است. ما سعي خواهيم کرد با استفاده از برنامهء حذف کننده آنرا پاک کنيم، پس از حذفِ برنامهء قديمي، نصبِ برنامهء جديد ادامه خواهد يافت. اگر شما تاکنون از فايلِ کليدِ در برنامهء موجودِ Martus هنوز نسخهء اضافي تهيه نکرده ايد، ما پيشنهاد مي کنيم از اين برنامه خارج شويد و نسخهء اضافي را تهيه کنيد و سپس برگرديد و برنامهء جديد را نصب کنيد. پس از اين کار شما دوباره مي توانيد برنامهء نصب کننده را به راه اندازيد. آيا حالا مي خواهيد به نصب ادامه دهيد؟"
!insertmacro LANG_STRING CannotUpgradeNoJava_Text "نسخه اي ازMartus را که شما هم اکنون نصب کرده ايد تنها زماني مي تواند جديدتر شود که از قبل نسخهء کامل برنامه نصب کننده به همراه Java(جاوا) پياده شده باشد."
!insertmacro LANG_STRING CannotRemoveInstallShieldVersion_Text "متأسفانه ما نتوانستيم نسخهء قديميِMartus را از روي كامپيوترِ شما حذف کنيم. برنامهء نصب کننده حالا خروج مي کند، شما خودتان براي حذف برنامهء Martus به قسمت Add/Remove(اضافه/حذف) در Control Panel(صفحهء کنترل) برويد و برنامه را از آنجا حذف کنيد، بعد دوباره به اين برنامهء نصب کننده برگرديد. اگر هنور نسخهء اضافي از کليدتان را در نسخهء فعليMartus تهيه نکرده ايد پيشنهاد مي کنين هم اکنون اين کار را پيش از پاک کردن برنامه بکنيد."
!insertmacro LANG_STRING CannotUpgradeNoMartus_Text "اين جديدترين نسخهء برنامهء Martus است. خواهش مي کنيم نسخهء کاملِ برنامهء نصب کننده (installer) را که حامل برنامهء جاوا (Java) است را پياده و نصب کنيد."

!insertmacro LANG_STRING UninstallMartusManuallyAndRemoveLinks_Text "در صورتی که شما از نسخه های قدیمی تر از 4.3 استفاده میکنید، قادر به ارتقا به نسخه جدید Martus  نخواهید بود. شما باید ابتدا نسخه قدیمیMartus  را حذف کنید.$\r$\n $\r$\n(یا از طریق: Start>Programs>Martus>Uninstall Martus و یا با استفاده از برنامه Add/Remove درکنترل پانل اپراتور دستگاه شما).$\r$\n $\r$\nاگر شما از ویندوز ویستا یا ویندوز 7 استفاده میکنید و آیکون Martus را در نوار Start خود قرار داده اید، در این صورت به احتمال زیاد نیاز خواهید داشت تا گروه مربوط به Martus  را نیز حذف کنید. (Start>Programs روی گروه Martus  کلیک سمت راست بر روی ماوس خود را فشار دهید و گزینه Delete را انتخاب کنید.)$\r$\n.در غیر اینصورت این لینکها حتی پس از حذف Martus بر روی ویندوز شما باقی خواهند ماند و ممکن است مشکلات امنیتی را در پی داشته باشد. "
