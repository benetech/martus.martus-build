...
!insertmacro LANG_STRING UninstallMartusManuallyAndRemoveLinks_Text "No se puede actualizar desde versiones de Martus mayores de 4.3 a la versión actual. Usted tendrá que desinstalar la versión anterior de Martus (ya sea en Inicio> Programas> Martus> Desinstalar Martus, o mediante Agregar / Quitar Programas en el Panel de control). Si está ejecutando Windows Vista o Windows 7 y tenía un acceso directo Martus en el menú Inicio, también puede ser necesario para eliminar el grupo Martus, vaya a Inicio> Todos los programas, haga clic en el grupo de Martus y picking 'Delete'. De lo contrario esos vínculos se mantendrán al desinstalar la versión actual de Martus, lo que podría ser un problema de seguridad."
