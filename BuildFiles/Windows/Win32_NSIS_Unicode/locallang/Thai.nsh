...
!insertmacro LANG_STRING FinishDialog_Text "${PRODUCT_NAME} ${PRODUCT_EXTENDED_VERSION} ถูกติดตั้งเรียบร้อยแล้ว.\r\n \r\n เยี่ยม https://www.martus.org/downloads/ เพื่อดูว่ามีการปรับปรุงใด ๆ แพ็ค Martus ภาษาที่ใช้ได้. \r\n \r\ชุดภาษา (ชุดภาษา) ยอมให้คุณติดตั้งการแปลภาษาที่ใหม่และอัปเดต หรือเอกสารทุกเวลาตามรุ่นของโปรแกรม Martus ชุดภาษา (ชุดภาษา) รวบรวมการแปลภาษาในส่วนการใช้งานของโปรแกรมลูกข่าย คู่มือการใช้งาน คู่มือฉบับย่อ ไพล์ README และการช่วยเหลือ ของโปรแกรม Martus ให้อัปเดต ถ้าลิ้งค์ชุดภาษาไทยของโปรแกรม Martus รุ่นที่คุณใช้งานปรากฎอยู่ด้านล่าง กรุณาดาวน์โหลดไฟล์ (Martus-th.mlp) และวางที่ไดเร็กทรอรี่ Martus เมื่อคุณเปิดโปรแกรม Martus ครั้งต่อไปมันจะอัปเดตการแปล และ/หรือ การช่วยเหลือ และใส่ทุกเอกสารที่อัปเดตในไดเรกทรอรี่ Martus\Docs\r\n \r\nคลิ๊กปุ่ม เสร็จสิ้น เพื่อออกจากโปรแกรม."
...
!insertmacro LANG_STRING UninstallMartusManuallyAndRemoveLinks_Text "คุณไม่สามารถปรับรุ่นจากรุ่น Martus เก่ากว่า 4.3 รุ่นปัจจุบัน คุณจำเป็นต้องถอนการติดตั้งรุ่นก่อนหน้านี้ของคุณ Martus (ทั้งภายใต้เริ่ม> โปรแกรม> Martus> ถอนการติดตั้ง Martus หรือใช้ Add / Remove Programs ใน Control Panel) หากคุณกำลังเรียกใช้ Windows Vista หรือ Windows 7 และมีทางลัด Martus ในเมนู Start ของคุณคุณยังอาจจำเป็นต้องลบกลุ่ม Martus โดยไปที่ Start> Programs, คลิกขวาที่กลุ่ม Martus และเลือก 'ลบ' มิฉะนั้นการเชื่อมโยงที่จะยังคงอยู่เมื่อคุณถอนการติดตั้งที่รุ่นปัจจุบันของ Martus ซึ่งอาจเป็นปัญหาการรักษาความปลอดภัย"
