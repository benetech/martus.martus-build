...
!insertmacro LANG_STRING UninstallMartusManuallyAndRemoveLinks_Text "Vous ne pouvez pas mettre à jour à partir des versions de Martus âgés de plus de 4.3 vers la version actuelle. Vous devez désinstaller votre ancienne version de Martus (que ce soit sous Démarrer> Programmes> Martus> Désinstaller Martus, ou en utilisant Ajout / Suppression de programmes du Panneau de configuration). Si vous utilisez Windows Vista ou Windows 7 et a eu un raccourci Martus dans votre menu Démarrer, vous pouvez aussi avoir besoin de retirer le groupe Martus en allant dans Démarrer> Programmes, un clic droit sur ​​le groupe Martus, et la cueillette «Supprimer». Sinon, ces liens resteront lorsque vous désinstallez la version actuelle de Martus, qui pourrait être un problème de sécurité."
