;Language: Burmese (xxxx) make some up number match in .nlf file (but must be unique so not to conflict with other languages
;By 

!insertmacro LANGFILE "ျမန္မာ" = "ျမန္မာ" =
