...
!insertmacro LANG_STRING UninstallMartusManuallyAndRemoveLinks_Text "Вы не можете обновить версии Martus старше 4,3 до текущей версии. Вам нужно удалить более ранней версии Martus (либо в меню Пуск> Программы> Martus> Удалить Martus, или с помощью Add / Remove Programs в панели управления). Если вы работаете в Windows Vista или Windows 7 и имел Martus ярлык в меню Пуск, вы можете также необходимо удалить Martus группу, перейдя в Пуск> Программы, щелкнув правой кнопкой мыши на группе Martus, и выбрать 'Удалить'. В противном случае эти ссылки останутся при удалении текущей версии Martus, которая могла бы представлять угрозу безопасности."
