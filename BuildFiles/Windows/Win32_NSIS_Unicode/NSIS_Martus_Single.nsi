...
preserve_existing_shortcuts:
    ...
    CreateShortCut "$SMPROGRAMS\Martus\Martus.lnk" "$INSTDIR\bin\javaw.exe" "-Xms256m -Xmx512m -jar $MARTUS_INSTALLATION_DIR\martus.jar" "$MARTUS_INSTALLATION_DIR\app.ico" 0 "" "" "$(MartusShortcutDescription_Text)"
