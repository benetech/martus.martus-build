...
!insertmacro LANG_STRING NeedAdminPrivileges_Text "You need administrative priviledges on the local machine to be able to install $(^Name)."
!insertmacro LANG_STRING NeedAdminPrivilegesError_Text "Unknown error getting admin priviledges. Verify you have administrative privileges on this machine otherwise the $(^Name) installation might not be successful."
