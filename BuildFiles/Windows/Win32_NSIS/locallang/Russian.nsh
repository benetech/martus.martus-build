...
!insertmacro LANG_STRING FinishDialog_Text "Установка ${PRODUCT_NAME} ${PRODUCT_EXTENDED_VERSION} выполнена.\r\n \r\n Загрузите обновленные локализованные пакеты документации Martus с сайта: http://www.martus.org/downloads. \r\n \r\nР›РѕРєР°Р»РёР·РѕРІР°РЅРЅС‹Р№ РїР°РєРµС‚ РґРѕРєСѓРјРµРЅС‚Р°С†РёРё ('Language Pack') РїРѕР·РІРѕР»С?РµС‚ Р·Р°РіСЂСѓР¶Р°С‚СЊ Рё СѓС?С‚Р°РЅР°РІР»РёРІР°С‚СЊ РЅРѕРІС‹Рµ Рё РёС?РїСЂР°РІР»РµРЅРЅС‹Рµ РїРµСЂРµРІРѕРґС‹ РґРѕРєСѓРјРµРЅС‚Р°С†РёРё РІ Р»СЋР±РѕРµ РІСЂРµРјС? РїРѕС?Р»Рµ РІС‹РїСѓС?РєР° РЅРѕРІРѕР№ РІРµСЂС?РёРё Martus. Р’ Р»РѕРєР°Р»РёР·РѕРІР°РЅРЅС‹Р№ РїР°РєРµС‚ РјРѕРіСѓС‚ РІС…РѕРґРёС‚СЊ: РёС?РїСЂР°РІР»РµРЅРЅС‹Рµ РІРµСЂС?РёРё Р»РѕРєР°Р»РёР·РѕРІР°РЅРЅРѕРіРѕ РєР»РёРµРЅС‚С?РєРѕРіРѕ РёРЅС‚РµСЂС„РµР№С?Р° Martus, Р СѓРєРѕРІРѕРґС?С‚РІРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»С?, Р­РєС?РїСЂРµС?С?-С?РїСЂР°РІРєР°, С„Р°Р№Р» README Рё РІС?С‚СЂРѕРµРЅРЅР°С? РІ РїСЂРѕРіСЂР°РјРјСѓ С?РїСЂР°РІРєР°.\r\n \r\nНажмите кнопку 'Готово$' для выхода из программы установки."
